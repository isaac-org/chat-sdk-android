...
public class BaseIncomingContextRootMessageViewHolder<T extends ContextRootMessageHolder> extends MessageHolders.BaseIncomingMessageViewHolder<T> {
    ...
    public BaseIncomingContextRootMessageViewHolder(View itemView, Object payload) {
